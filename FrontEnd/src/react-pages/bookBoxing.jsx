  ...
  const handleBooking = async () => {
    ...
    if (selectedDate && selectedTime) {
      ...
      try {
        ...
        if (response.ok) {
          alert(`Booking confirmed for Boxing on ${bookingDate.toDateString()} at ${selectedTime}`);
        } else {
  ...
  return (
    <React.Fragment>
      ...
      <div className="pilates-container">
        <img 
          src="/src/assets/boxing.jpg"
          alt="Boxing" 
          className="pilates-image"
        />
        <p className="pilates-description">
          Boxing is a combat sport focused on striking with fists, improving strength, agility, and endurance.
        </p>
        <p className="pilates-description">
      ...
      <div className="calendar-container">
        ...
        {selectedDate && (
          <div className="time-slots-container">
            ...
            <button className="book-button" onClick={handleBooking}>Book Boxing</button>
          </div>
        )}
      </div>
      <Footer />
...
ReactDOM.createRoot(document.getElementById("root")).render(<BookBoxing />);
