...
function BookWeightTraining() {
  ...
  const handleBooking = async () => {
    ...
    const booking_type = "Weight Training";
    ...
    if (selectedDate && selectedTime) {
      ...
      try {
        ...
        if (response.ok) {
          alert(`Booking confirmed for Weight Training on ${bookingDate.toDateString()} at ${selectedTime}`);
        } else {
    ...
    <React.Fragment>
      ...
      <div className="pilates-container">
        ...
        <p className="pilates-description">
          Weight training focuses on lifting weights to build muscle and enhance strength.
        </p>
        <p className="pilates-description">
      ...
      <div className="calendar-container">
        ...
        {selectedDate && (
          <div className="time-slots-container">
            ...
            <button className="book-button" onClick={handleBooking}>Book Weight Training</button>
          </div>
        )}
      </div>
      <Footer />
...
ReactDOM.createRoot(document.getElementById("root")).render(<BookWeightTraining />);
