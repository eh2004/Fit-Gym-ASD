  ...
  const handleBooking = async () => {
    ...
    if (selectedDate && selectedTime) {
      ...
      try {
        ...
        if (response.ok) {
          alert(`Booking confirmed for CrossFit on ${bookingDate.toDateString()} at ${selectedTime}`);
        } else {
    ...
    <React.Fragment>
      ...
      <div className="pilates-container">
        ...
        <p className="pilates-description">
          CrossFit combines elements of weightlifting, cardio, and functional movements for full-body conditioning.
        </p>
        <p className="pilates-description">
      ...
      <div className="calendar-container">
        ...
        {selectedDate && (
          <div className="time-slots-container">
            ...
            <button className="book-button" onClick={handleBooking}>Book CrossFit</button>
          </div>
        )}
      </div>
      <Footer />
...
ReactDOM.createRoot(document.getElementById("root")).render(<BookCrossfit />);
